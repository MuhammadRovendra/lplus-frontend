...
const AddBundlePage = () => {
  ...
  const handleAddBundle = async () => {
    if (!kategori.trim() || !deskripsi.trim() || !image) {
      return SweetAlertService.showError("Error", "Kategori, deskripsi, dan gambar wajib diisi!");
    }
  ...
  return (
    <>
      <Layout>
        <h1 className="text-xl font-bold mt-12 md:mt-12">Add Bundle</h1>
